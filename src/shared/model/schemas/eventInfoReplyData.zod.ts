...
export const EventInfoReplyData = zod.object({
  event: zod
    .object({
...
export type EventInfoReplyData = zod.input<typeof EventInfoReplyData>;
export type EventInfoReplyDataOutput = zod.output<typeof EventInfoReplyData>;
