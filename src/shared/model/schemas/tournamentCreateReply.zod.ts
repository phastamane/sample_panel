...
export const TournamentCreateReply = zod.object({
  data: zod
    .object({
      tournament: zod
        .object({
...
export type TournamentCreateReply = zod.input<typeof TournamentCreateReply>;
export type TournamentCreateReplyOutput = zod.output<
  typeof TournamentCreateReply
>;
