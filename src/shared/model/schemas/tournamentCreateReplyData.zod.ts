...
export const TournamentCreateReplyData = zod.object({
  tournament: zod
    .object({
...
export type TournamentCreateReplyData = zod.input<
  typeof TournamentCreateReplyData
>;
export type TournamentCreateReplyDataOutput = zod.output<
  typeof TournamentCreateReplyData
>;
