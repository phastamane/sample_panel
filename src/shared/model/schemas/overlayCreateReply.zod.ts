...
export const OverlayCreateReply = zod.object({
  data: zod
    .object({
      overlay: zod
        .object({
...
export type OverlayCreateReply = zod.input<typeof OverlayCreateReply>;
export type OverlayCreateReplyOutput = zod.output<typeof OverlayCreateReply>;
