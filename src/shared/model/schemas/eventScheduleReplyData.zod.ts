...
export const EventScheduleReplyData = zod.object({
  event: zod
    .object({
...
export type EventScheduleReplyData = zod.input<typeof EventScheduleReplyData>;
export type EventScheduleReplyDataOutput = zod.output<
  typeof EventScheduleReplyData
>;
