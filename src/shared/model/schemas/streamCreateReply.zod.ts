...
export const StreamCreateReply = zod.object({
  data: zod
    .object({
      stream: zod
        .object({
...
export type StreamCreateReply = zod.input<typeof StreamCreateReply>;
export type StreamCreateReplyOutput = zod.output<typeof StreamCreateReply>;
