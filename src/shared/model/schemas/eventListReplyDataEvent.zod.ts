...
export const EventListReplyDataEvent = zod.object({
...
export type EventListReplyDataEvent = zod.input<typeof EventListReplyDataEvent>;
export type EventListReplyDataEventOutput = zod.output<
  typeof EventListReplyDataEvent
>;
