...
export const EventCreateReply = zod.object({
  data: zod
    .object({
      event: zod
        .object({
...
export type EventCreateReply = zod.input<typeof EventCreateReply>;
export type EventCreateReplyOutput = zod.output<typeof EventCreateReply>;
