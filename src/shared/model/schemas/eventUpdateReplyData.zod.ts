...
export const EventUpdateReplyData = zod.object({
  event: zod
    .object({
...
export type EventUpdateReplyData = zod.input<typeof EventUpdateReplyData>;
export type EventUpdateReplyDataOutput = zod.output<
  typeof EventUpdateReplyData
>;
