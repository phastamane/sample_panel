...
export const OverlayUpdateReply = zod.object({
  data: zod
    .object({
      overlay: zod
        .object({
...
export type OverlayUpdateReply = zod.input<typeof OverlayUpdateReply>;
export type OverlayUpdateReplyOutput = zod.output<typeof OverlayUpdateReply>;
