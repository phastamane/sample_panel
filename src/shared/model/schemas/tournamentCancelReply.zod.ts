...
export const TournamentCancelReply = zod.object({
  data: zod
    .object({
      tournament: zod
        .object({
...
export type TournamentCancelReply = zod.input<typeof TournamentCancelReply>;
export type TournamentCancelReplyOutput = zod.output<
  typeof TournamentCancelReply
>;
