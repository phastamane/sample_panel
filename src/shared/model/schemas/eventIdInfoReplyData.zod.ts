...
export const EventIdInfoReplyData = zod.object({
  event: zod
    .object({
...
export type EventIdInfoReplyData = zod.input<typeof EventIdInfoReplyData>;
export type EventIdInfoReplyDataOutput = zod.output<
  typeof EventIdInfoReplyData
>;
