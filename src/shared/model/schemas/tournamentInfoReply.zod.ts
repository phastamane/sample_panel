...
export const TournamentInfoReply = zod.object({
  data: zod
    .object({
      tournament: zod
        .object({
...
export type TournamentInfoReply = zod.input<typeof TournamentInfoReply>;
export type TournamentInfoReplyOutput = zod.output<typeof TournamentInfoReply>;
