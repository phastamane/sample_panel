...
export const TournamentStartReply = zod.object({
  data: zod
    .object({
      tournament: zod
        .object({
...
export type TournamentStartReply = zod.input<typeof TournamentStartReply>;
export type TournamentStartReplyOutput = zod.output<
  typeof TournamentStartReply
>;
