...
export const EventScheduleReply = zod.object({
  data: zod
    .object({
      event: zod
        .object({
...
export type EventScheduleReply = zod.input<typeof EventScheduleReply>;
export type EventScheduleReplyOutput = zod.output<typeof EventScheduleReply>;
