...
export const VenueInfoReplyData = zod.object({
  venue: zod
    .object({
...
export type VenueInfoReplyData = zod.input<typeof VenueInfoReplyData>;
export type VenueInfoReplyDataOutput = zod.output<typeof VenueInfoReplyData>;
