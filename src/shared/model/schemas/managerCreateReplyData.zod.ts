...
export const ManagerCreateReplyData = zod.object({
  manager: zod
    .object({
...
export type ManagerCreateReplyData = zod.input<typeof ManagerCreateReplyData>;
export type ManagerCreateReplyDataOutput = zod.output<
  typeof ManagerCreateReplyData
>;
