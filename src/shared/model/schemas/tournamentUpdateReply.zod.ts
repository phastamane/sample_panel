...
export const TournamentUpdateReply = zod.object({
  data: zod
    .object({
      tournament: zod
        .object({
...
export type TournamentUpdateReply = zod.input<typeof TournamentUpdateReply>;
export type TournamentUpdateReplyOutput = zod.output<
  typeof TournamentUpdateReply
>;
