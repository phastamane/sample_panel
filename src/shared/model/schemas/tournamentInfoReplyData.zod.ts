...
export const TournamentInfoReplyData = zod.object({
  tournament: zod
    .object({
...
export type TournamentInfoReplyData = zod.input<typeof TournamentInfoReplyData>;
export type TournamentInfoReplyDataOutput = zod.output<
  typeof TournamentInfoReplyData
>;
