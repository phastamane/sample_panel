...
export const ManagerAuthReply = zod.object({
  data: zod
    .object({
      manager: zod
        .object({
...
export type ManagerAuthReply = zod.input<typeof ManagerAuthReply>;
export type ManagerAuthReplyOutput = zod.output<typeof ManagerAuthReply>;
