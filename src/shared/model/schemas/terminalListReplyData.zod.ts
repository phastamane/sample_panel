...
export const TerminalListReplyData = zod.object({
  terminals: zod
    .array(
      zod.object({
...
export type TerminalListReplyData = zod.input<typeof TerminalListReplyData>;
export type TerminalListReplyDataOutput = zod.output<
  typeof TerminalListReplyData
>;
