...
export const ManagerListReplyData = zod.object({
  managers: zod
    .array(
      zod.object({
...
export type ManagerListReplyData = zod.input<typeof ManagerListReplyData>;
export type ManagerListReplyDataOutput = zod.output<
  typeof ManagerListReplyData
>;
