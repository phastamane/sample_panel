...
export const OverlayIdInfoReplyData = zod.object({
  overlay: zod
    .object({
...
export type OverlayIdInfoReplyData = zod.input<typeof OverlayIdInfoReplyData>;
export type OverlayIdInfoReplyDataOutput = zod.output<
  typeof OverlayIdInfoReplyData
>;
