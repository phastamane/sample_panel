...
export const TournamentScheduleReplyData = zod.object({
  tournament: zod
    .object({
...
export type TournamentScheduleReplyData = zod.input<
  typeof TournamentScheduleReplyData
>;
export type TournamentScheduleReplyDataOutput = zod.output<
  typeof TournamentScheduleReplyData
>;
