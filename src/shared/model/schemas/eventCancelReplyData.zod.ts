...
export const EventCancelReplyData = zod.object({
  event: zod
    .object({
...
export type EventCancelReplyData = zod.input<typeof EventCancelReplyData>;
export type EventCancelReplyDataOutput = zod.output<
  typeof EventCancelReplyData
>;
