...
export const EventCreateSchemaData = zod.object({
  event: zod
    .object({
...
export type EventCreateSchemaData = zod.input<typeof EventCreateSchemaData>;
export type EventCreateSchemaDataOutput = zod.output<
  typeof EventCreateSchemaData
>;
