...
export const OverlayListReplyData = zod.object({
  overlays: zod
    .array(
      zod.object({
...
export type OverlayListReplyData = zod.input<typeof OverlayListReplyData>;
export type OverlayListReplyDataOutput = zod.output<
  typeof OverlayListReplyData
>;
