...
export const VenueCreateReply = zod.object({
  data: zod
    .object({
      venue: zod
        .object({
...
export type VenueCreateReply = zod.input<typeof VenueCreateReply>;
export type VenueCreateReplyOutput = zod.output<typeof VenueCreateReply>;
