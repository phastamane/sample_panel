...
export const TournamentUpdateReplyData = zod.object({
  tournament: zod
    .object({
...
export type TournamentUpdateReplyData = zod.input<
  typeof TournamentUpdateReplyData
>;
export type TournamentUpdateReplyDataOutput = zod.output<
  typeof TournamentUpdateReplyData
>;
