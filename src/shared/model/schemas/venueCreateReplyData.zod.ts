...
export const VenueCreateReplyData = zod.object({
  venue: zod
    .object({
...
export type VenueCreateReplyData = zod.input<typeof VenueCreateReplyData>;
export type VenueCreateReplyDataOutput = zod.output<
  typeof VenueCreateReplyData
>;
