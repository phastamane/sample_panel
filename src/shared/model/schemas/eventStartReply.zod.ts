...
export const EventStartReply = zod.object({
  data: zod
    .object({
      event: zod
        .object({
...
export type EventStartReply = zod.input<typeof EventStartReply>;
export type EventStartReplyOutput = zod.output<typeof EventStartReply>;
