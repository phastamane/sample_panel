...
export const ManagerCreateReply = zod.object({
  data: zod
    .object({
      manager: zod
        .object({
...
export type ManagerCreateReply = zod.input<typeof ManagerCreateReply>;
export type ManagerCreateReplyOutput = zod.output<typeof ManagerCreateReply>;
