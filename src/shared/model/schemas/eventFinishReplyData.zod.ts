...
export const EventFinishReplyData = zod.object({
  event: zod
    .object({
...
export type EventFinishReplyData = zod.input<typeof EventFinishReplyData>;
export type EventFinishReplyDataOutput = zod.output<
  typeof EventFinishReplyData
>;
