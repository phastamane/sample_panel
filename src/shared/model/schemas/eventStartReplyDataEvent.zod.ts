...
export const EventStartReplyDataEvent = zod.object({
...
export type EventStartReplyDataEvent = zod.input<
  typeof EventStartReplyDataEvent
>;
export type EventStartReplyDataEventOutput = zod.output<
  typeof EventStartReplyDataEvent
>;
