...
export const TerminalCreateReply = zod.object({
  data: zod
    .object({
      terminal: zod
        .object({
...
export type TerminalCreateReply = zod.input<typeof TerminalCreateReply>;
export type TerminalCreateReplyOutput = zod.output<typeof TerminalCreateReply>;
