...
export const EventStartReplyData = zod.object({
  event: zod
    .object({
...
export type EventStartReplyData = zod.input<typeof EventStartReplyData>;
export type EventStartReplyDataOutput = zod.output<typeof EventStartReplyData>;
