...
export const EventInfoReplyDataEvent = zod.object({
...
export type EventInfoReplyDataEvent = zod.input<typeof EventInfoReplyDataEvent>;
export type EventInfoReplyDataEventOutput = zod.output<
  typeof EventInfoReplyDataEvent
>;
