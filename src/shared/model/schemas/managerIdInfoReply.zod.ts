...
export const ManagerIdInfoReply = zod.object({
  data: zod
    .object({
      manager: zod
        .object({
...
export type ManagerIdInfoReply = zod.input<typeof ManagerIdInfoReply>;
export type ManagerIdInfoReplyOutput = zod.output<typeof ManagerIdInfoReply>;
