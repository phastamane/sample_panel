...
export const OverlayInfoReply = zod.object({
  data: zod
    .object({
      overlay: zod
        .object({
...
export type OverlayInfoReply = zod.input<typeof OverlayInfoReply>;
export type OverlayInfoReplyOutput = zod.output<typeof OverlayInfoReply>;
