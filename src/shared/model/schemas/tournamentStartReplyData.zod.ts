...
export const TournamentStartReplyData = zod.object({
  tournament: zod
    .object({
...
export type TournamentStartReplyData = zod.input<
  typeof TournamentStartReplyData
>;
export type TournamentStartReplyDataOutput = zod.output<
  typeof TournamentStartReplyData
>;
