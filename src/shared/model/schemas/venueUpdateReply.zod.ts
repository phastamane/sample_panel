...
export const VenueUpdateReply = zod.object({
  data: zod
    .object({
      venue: zod
        .object({
...
export type VenueUpdateReply = zod.input<typeof VenueUpdateReply>;
export type VenueUpdateReplyOutput = zod.output<typeof VenueUpdateReply>;
