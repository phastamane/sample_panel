...
export const EventCreateReplyData = zod.object({
  event: zod
    .object({
...
export type EventCreateReplyData = zod.input<typeof EventCreateReplyData>;
export type EventCreateReplyDataOutput = zod.output<
  typeof EventCreateReplyData
>;
