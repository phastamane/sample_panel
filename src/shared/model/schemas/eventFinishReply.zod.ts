...
export const EventFinishReply = zod.object({
  data: zod
    .object({
      event: zod
        .object({
...
export type EventFinishReply = zod.input<typeof EventFinishReply>;
export type EventFinishReplyOutput = zod.output<typeof EventFinishReply>;
