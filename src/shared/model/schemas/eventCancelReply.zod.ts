...
export const EventCancelReply = zod.object({
  data: zod
    .object({
      event: zod
        .object({
...
export type EventCancelReply = zod.input<typeof EventCancelReply>;
export type EventCancelReplyOutput = zod.output<typeof EventCancelReply>;
