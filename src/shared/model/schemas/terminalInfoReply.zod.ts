...
export const TerminalInfoReply = zod.object({
  data: zod
    .object({
      terminal: zod
        .object({
...
export type TerminalInfoReply = zod.input<typeof TerminalInfoReply>;
export type TerminalInfoReplyOutput = zod.output<typeof TerminalInfoReply>;
