...
export const OverlayInfoReplyData = zod.object({
  overlay: zod
    .object({
...
export type OverlayInfoReplyData = zod.input<typeof OverlayInfoReplyData>;
export type OverlayInfoReplyDataOutput = zod.output<
  typeof OverlayInfoReplyData
>;
