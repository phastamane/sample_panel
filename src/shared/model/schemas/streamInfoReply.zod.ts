...
export const StreamInfoReply = zod.object({
  data: zod
    .object({
      stream: zod
        .object({
...
export type StreamInfoReply = zod.input<typeof StreamInfoReply>;
export type StreamInfoReplyOutput = zod.output<typeof StreamInfoReply>;
