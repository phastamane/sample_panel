...
export const TournamentFinishReply = zod.object({
  data: zod
    .object({
      tournament: zod
        .object({
...
export type TournamentFinishReply = zod.input<typeof TournamentFinishReply>;
export type TournamentFinishReplyOutput = zod.output<
  typeof TournamentFinishReply
>;
