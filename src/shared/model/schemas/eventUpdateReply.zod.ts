...
export const EventUpdateReply = zod.object({
  data: zod
    .object({
      event: zod
        .object({
...
export type EventUpdateReply = zod.input<typeof EventUpdateReply>;
export type EventUpdateReplyOutput = zod.output<typeof EventUpdateReply>;
