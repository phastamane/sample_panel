...
export const ManagerAuthReplyData = zod.object({
  manager: zod
    .object({
...
export type ManagerAuthReplyData = zod.input<typeof ManagerAuthReplyData>;
export type ManagerAuthReplyDataOutput = zod.output<
  typeof ManagerAuthReplyData
>;
