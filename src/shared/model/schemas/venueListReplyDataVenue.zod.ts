...
export const VenueListReplyDataVenue = zod.object({
...
export type VenueListReplyDataVenue = zod.input<typeof VenueListReplyDataVenue>;
export type VenueListReplyDataVenueOutput = zod.output<
  typeof VenueListReplyDataVenue
>;
