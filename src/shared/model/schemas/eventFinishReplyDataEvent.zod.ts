...
export const EventFinishReplyDataEvent = zod.object({
...
export type EventFinishReplyDataEvent = zod.input<
  typeof EventFinishReplyDataEvent
>;
export type EventFinishReplyDataEventOutput = zod.output<
  typeof EventFinishReplyDataEvent
>;
