...
export const StreamIdUpdateSchema = zod.object({
  data: zod
    .object({
      stream: zod
        .object({
...
export type StreamIdUpdateSchema = zod.input<typeof StreamIdUpdateSchema>;
export type StreamIdUpdateSchemaOutput = zod.output<
  typeof StreamIdUpdateSchema
>;
